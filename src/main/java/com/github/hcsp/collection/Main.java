...
public class Main {
    ...
    public static Map<String, List<User>> collect(List<User> users) {
        HashMap<String, List<User>> map = categoryUserByDepartment(users);
        sortUsersByAge(map);
        return map;
    }

    public static void sortUsersByAge(HashMap<String, List<User>> map) {
        for (List<User> userList : map.values()) {
            Collections.sort(userList);
        }
    }

    public static HashMap<String, List<User>> categoryUserByDepartment(List<User> users) {
